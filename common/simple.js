...
const upFile = _obj => {
   return new Promise(function (resolve, reject) {
      var _o = {
         url: config.host + config.dApi.upImage, //仅为示例，非真实的接口地址
         filePath: "",
         header: {
            "token": user.token
         },
...
module.exports = { B, C, DF, G, S, R, RS, P, STATE, sendSMS, wxLogin, upFile, chooseImage, formatData, dateFormat, getParentPage }
